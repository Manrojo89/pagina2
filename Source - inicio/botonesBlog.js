...
document.getElementById('btnReseñaFifa').addEventListener('click', function() {
    window.location.href = '../Blog/reseñas/EASports.html';
});

document.getElementById('btnReseñaDeadRising').addEventListener('click', function() {
    window.location.href = '../Blog/reseñas/DeadRisingDeluxeRemaster.html';
});

document.getElementById('nuevosProductos').addEventListener('click', function() {
    window.location.href = '../Blog/reseñas/nuevosProductos.html';
});

document.getElementById('btnTutoriales').addEventListener('click', function() {
    window.location.href = '../Blog/reseñas/tutorialesOtroquest.html';
});

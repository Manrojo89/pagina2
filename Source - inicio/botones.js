...
document.getElementById('agendaTransmision').addEventListener('click', function() {
    window.location.href = '../Transmision/transmision.html'; 
});
...
document.getElementById('btnFrancia').addEventListener('click', function() {
    window.location.href = '../Tienda/tienda.html';
});
...
document.getElementById('btnApoyar').addEventListener('click', function() {
    window.location.href = '../Apóyame/apoyame.html';
});

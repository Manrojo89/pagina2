...
document.getElementById('btnEaSports').addEventListener('click', function() {
    window.location.href = 'EASports.html';
});

document.getElementById('btnNuevos').addEventListener('click', function() {
    window.location.href = 'nuevosProductos.html';
});
